...
export default function MonitorWaiterOrdersPage() {
  ...
  async function loadOrders() {
    try {
      const [p, a, k, ready, rts, rej] = await Promise.all([
        listStaffOrdersForMonitorApi({ status: "pending" }),
        listStaffOrdersForMonitorApi({ status: "accepted" }),
        listStaffOrdersForMonitorApi({ status: "preparing" }),
        listStaffOrdersForMonitorApi({ status: "ready" }),
        listStaffOrdersForMonitorApi({ status: "ready_to_service" }),
        listStaffOrdersForMonitorApi({ status: "cancelled" }),
      ]);
